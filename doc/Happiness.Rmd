...
+ `DT` provides an R interface to the JavaScript library DataTables.
 ...
 And state clearly that your Rnotebook requires so and so packages in your R notebook and what system you are running also helps. 
